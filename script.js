function compute()
{
    //getting values from HTML element IDs
    ...
    document.getElementById("result").innerHTML = "<br/>If you deposit <mark>" + principal + "</mark>,<br/>" + "at an interest rate of <mark>" + rate + "%</mark>,<br/>" +
    "You will receive an amount of <mark>" + interest + "</mark>,<br/> " +  "in the year <mark>" + yearFuture + "</mark>";
}

function updateRate() 
{
    //read rate value and displays
